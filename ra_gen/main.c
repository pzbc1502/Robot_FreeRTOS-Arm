...
#include "bsp_api.h"
                ...
                #include "task.h"
                #include "semphr.h"
                extern void robot_thread_create(void);
                extern TaskHandle_t robot_thread;
extern void vision_service_thread_create(void);
                extern TaskHandle_t vision_service_thread;
